...
Player::Player(unsigned int id, unsigned int health, float damage, float shield_points, float speed, float jump_factor) :
	id(0), health(100), damage(5.0f), shield_points(1.0f), speed(25.0f), jump_factor(3.0f) {}
...
float Player::get_shield_points()
{
