...
SRC = main.cpp src/player/player.cpp src/player/player_profile.cpp src/player/player_status.cpp src/obstacles/obstacle.cpp src/checkpoint/checkpoint.cpp \
		src/scores/score.cpp src/level/level.cpp src/level/levels.cpp src/level/level_status.cpp src/level/terrain.cpp src/enemy/enemy.cpp src/enemy/enemy_status.cpp \
